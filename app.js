...
app.get('/home', function (req, res) {
    if(sessions && sessions.username){
        ...
        res.send('Простите, но ваша сессия закончилась, войдите в своюучетную запись заново');
    }
})
...
app.get('/getAirs', function (req,res) {
...
app.listen(7777,function(){
    console.log("Сервер запущен на порте: ", 7777);
})